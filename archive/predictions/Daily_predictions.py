...
# ---------------------------
# Load and Aggregate Data to Daily Values
# ---------------------------
...
'''
# Aggregate hourly data to daily by summing the consumption values
df = df.resample('D').sum()

print("Dataset Information (Daily Aggregation):")
...
# Additional advanced lag features
...
plt.tight_layout()
plt.savefig("results/daily/correlation_heatmap.png")
plt.close()
...
plt.tight_layout()
plt.savefig("results/daily/time_series_plot.png")
plt.close()
...
forecast_df.to_csv("results/daily/predicted_values_kwh.csv")
print("\nPredicted values have been saved to 'results/daily/predicted_values_kwh.csv'")
...
feature_importance.to_csv("results/daily/feature_importance.csv", index=False)
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("results/daily/forecast_comparison.png")
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("results/daily/residuals.png")
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig("results/daily/error_distribution.png")
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig("results/daily/error_by_day.png")
plt.close()

print("\nAll daily visualizations have been saved in the 'results/daily' directory.")

...
os.makedirs("results/forecast7_days", exist_ok=True)
...
plt.tight_layout()
plt.savefig("results/forecast7_days/correlation_heatmap.png")
plt.close()
...
plt.tight_layout()
plt.savefig("results/forecast7_days/time_series_plot.png")
plt.close()
...
forecast_recursive_df.to_csv("results/forecast7_days/recursive_forecast_next_7_days.csv")
print("7-day recursive forecast has been saved to 'results/forecast7_days/recursive_forecast_next_7_days.csv'.")

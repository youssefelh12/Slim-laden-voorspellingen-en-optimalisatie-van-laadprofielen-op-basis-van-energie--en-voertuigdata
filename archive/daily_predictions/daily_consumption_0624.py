...
def add_lag_features(df, be_holidays):
    ...
    # df['consumption_lag_365d'] = df['Total_consumption'].shift(365)  # Removed due to insufficient data length
...
def main():
    ...
    results_dir = "results/daily_building_0624"
    ...
    exog_features = [
        ...
        "rolling_avg_3d", "rolling_std_3d",'is_terugkomdag','cumulative_ev_phev_count'
    ]
    ...
    print("\nAll daily visualizations have been saved in the 'results/daily_building_0624' directory.")

...
os.makedirs("results/daily_cleaned", exist_ok=True)
...
plt.tight_layout()
plt.savefig("results/daily_cleaned/correlation_heatmap.png")
plt.close()
...
plt.tight_layout()
plt.savefig("results/daily_cleaned/time_series_plot.png")
plt.close()
...
forecast_df.to_csv("results/daily_cleaned/predicted_values_kwh.csv")
print("\nPredicted values have been saved to 'results/daily_cleaned/predicted_values_kwh.csv'")
...
feature_importance.to_csv("results/daily_cleaned/feature_importance.csv", index=False)
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("results/daily_cleaned/forecast_comparison.png")
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("results/daily_cleaned/residuals.png")
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig("results/daily_cleaned/error_distribution.png")
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig("results/daily_cleaned/error_by_day.png")
plt.close()

print("\nAll daily visualizations have been saved in the 'results/daily_cleaned' directory.")

...
for day in days_iter:
    ...
    # SARIMAX-model met wekelijks seizoen (s=168 uur)
    ...
    # ── BUILD feature frame voor de predictiedag ──
    ...
    fc = sarimax_res.get_forecast(
        steps=len(day_df),
        exog=day_df[FEATURES]
    )
    day_df['yhat'] = fc.predicted_mean.values
